...
describe('RegistrationDisabled Component', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should display the EVA logo', () => {
      renderComponent()
      const logo = screen.getByAltText('EVA Logo')
  ...
  describe('Styling', () => {
    it('should have correct background color', () => {
      ...
      // CSS custom property (jsdom keeps it literal) or the resolved hex/rgb
      expect(mainDiv.style.background).toMatch(
        /var\(--surface-primary\)|rgb\(11,\s*14,\s*17\)|#0B0E11/i
      )
    })
    ...
    it('should have correct text color', () => {
      ...
      const mainDiv = container.firstChild as HTMLElement
      // CSS custom property (jsdom keeps it literal) or the resolved hex/rgb
      expect(mainDiv.style.color).toMatch(
        /var\(--text-primary\)|rgb\(234,\s*236,\s*239\)|#EAECEF/i
      )
    })
