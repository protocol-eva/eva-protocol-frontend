...
export function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <aside
        className="hidden lg:flex fixed left-0 top-0 h-screen w-[500px] z-20 flex-col overflow-hidden gl-edge-glow"
        style={{
          background:
      ...
      <div className="absolute inset-0 z-10 overflow-y-auto lg:pl-[500px]">
                  ...
                  {adminMode ? (
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                      ...
                      <div className="flex justify-center pt-1">
                        <LiquidMetalBar type="submit" disabled={loading}>
                          {loading
                            ? language === 'zh'
                              ? '登录中...'
                              : 'Signing in…'
