  ...
  return (
    <section id="features" className="py-24 bg-zinc-950 relative">
      <div className="max-w-[1920px] mx-auto px-6 lg:px-16">
        <div className="mb-16 border-l-4 border-eva-gold pl-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1">
          {features.map((f, i) => (
            ...
            >
              ...
              <f.icon className="w-10 h-10 text-eva-gold mb-6" />
              ...
              <div className="absolute bottom-0 left-0 w-full h-1 bg-eva-gold transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-300" />
            </motion.div>
          ))}
        </div>
      </div>
