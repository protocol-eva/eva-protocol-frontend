      ...
      <div className="relative bg-[#0B0F14] rounded-2xl overflow-hidden shadow-2xl shadow-black/80 border border-zinc-800/80">
        ...
        <div className="p-4 border-b border-zinc-800/40">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex gap-1">
              <button className="px-2 py-0.5 bg-eva-gold/20 border border-eva-gold/30 rounded text-[10px] text-eva-gold font-mono">
                24H
              </button>
              <button className="px-2 py-0.5 text-[10px] text-zinc-600 font-mono hover:text-zinc-400 transition-colors">
                7D
              </button>
              <button className="px-2 py-0.5 text-[10px] text-zinc-600 font-mono hover:text-zinc-400 transition-colors">
                30D
        ...
        <div className="grid grid-cols-3 divide-x divide-zinc-800/40 border-b border-zinc-800/40">
          <div className="p-3 text-center">
            <div className="text-zinc-500 text-[10px] font-mono uppercase tracking-wider mb-1">
              OI
            </div>
        ...
        <div className="p-4 border-b border-zinc-800/40">
          <div className="flex items-center justify-between mb-3">
            ...
            <span className="text-zinc-600 text-[10px] font-mono">
              Spread: <span className="text-eva-gold">0.02%</span>
            </span>
          </div>
            ...
            <div className="space-y-1">
              {[
                ...
                >
                  ...
                  <span className="relative text-zinc-500 font-mono">
                    {ask.amount}
                  </span>
                </div>
              ))}
        ...
        <div className="p-4">
          ...
          <div className="space-y-2">
            {[
              ...
              <div
                key={i}
                className="flex items-center justify-between py-2 px-2 rounded-lg bg-zinc-900/50 hover:bg-zinc-800/50 transition-colors"
              >
