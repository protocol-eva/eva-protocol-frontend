    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(var(--eva-gold) 1px, transparent 1px), linear-gradient(90deg, var(--eva-gold) 1px, transparent 1px)`,
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
        ...
        >
          <Zap className="w-4 h-4" style={{ color: 'var(--eva-gold)' }} />
          <span
        ...
        >
          ...
          >
            ...
            <motion.span
              ...
              style={{
                background:
                  'linear-gradient(90deg, var(--eva-gold), var(--accent-primary-hover))',
              }}
              initial={{ width: 0 }}
              animate={{ width: '100%' }}
      ...
      >
        <motion.div
          ...
          style={{ border: '2px solid var(--eva-border)' }}
          animate={{ y: [0, 8, 0] }}
          transition={{ duration: 2, repeat: Infinity }}
        >
          <motion.div
            className="w-1.5 h-3 rounded-full"
            style={{ background: 'var(--eva-gold)' }}
          />
        </motion.div>
      </motion.div>
    </section>
