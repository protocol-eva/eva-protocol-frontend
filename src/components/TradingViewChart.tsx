...
function TradingViewChartComponent({
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      ...
      backgroundColor: getCssVar('--surface-primary'),
      gridColor: getCssVar('--surface-tertiary'),
  ...
  return (
    <div
      ...
      style={
        isFullscreen ? { background: 'var(--surface-primary)' } : undefined
      }
    >
      {/* Header */}
      <div
        ...
        style={{
          borderBottom: embedded ? 'none' : '1px solid var(--surface-tertiary)',
        }}
      >
        {!embedded && (
          ...
          <button
            ...
            style={{
              background: isFullscreen
                ? 'var(--accent-primary)'
                : 'transparent',
              color: isFullscreen ? '#0B0E11' : 'var(--text-secondary)',
