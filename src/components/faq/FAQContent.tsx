  ...
  return (
    <div className="space-y-12">
      {categories.map((category) => (
        <div
          key={category.id}
          className="eva-glass p-8 rounded-xl border border-white/5"
        >
          {/* Category Header */}
          <div className="flex items-center gap-3 mb-6 pb-3 border-b border-white/10">
            <category.icon className="w-7 h-7 text-eva-gold" />
            <h2 className="text-2xl font-bold text-eva-text-main">
          ...
          <div className="space-y-8">
            {category.items.map((item) => (
              ...
              >
                {/* Question */}
                <h3 className="text-xl font-semibold mb-3 text-eva-text-main">
                  {t(item.questionKey, language)}
                </h3>

                {/* Answer */}
                <div className="prose prose-invert max-w-none text-eva-text-muted leading-relaxed">
                  {item.id === 'github-projects-tasks' ? (
                      ...
                      >
                        {language === 'zh' ? (
                          <div className="text-sm">
                            <strong style={{ color: 'var(--eva-gold)' }}>
                              提示：
                            </strong>{' '}
                            参与贡献将享有激励制度（如
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="rounded p-3 mt-3 bg-eva-gold/10 border border-eva-gold/25">
                        {language === 'zh' ? (
                          <div className="text-sm">
                            <strong className="text-eva-gold">Note:</strong>{' '}
