      ...
      <nav className="fixed top-0 left-0 right-0 z-50">
        <div className="gl-navbar flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-1">
                {OFFICIAL_LINKS.github ? (
                  <a
                    ...
                    className="social-link p-2 rounded-lg text-nofx-text-muted"
                    title="GitHub"
                  >
                    <svg
                      width="18"
                  ...
                  <span
                    className="p-2 rounded-lg text-nofx-text-muted cursor-default opacity-60"
                    title="GitHub"
                  >
                    <svg
                      width="18"
          ...
          <motion.button
            ...
            className="md:hidden ml-auto text-nofx-text-muted hover:text-white p-2"
            whileTap={{ scale: 0.9 }}
          >
            {mobileMenuOpen ? (
              <X className="w-6 h-6" />
