...
export interface CoinSourceConfig {
  ...
  use_oi_low: boolean
  oi_low_limit?: number
  // Note: API URLs are now built automatically using evaos_api_key from IndicatorConfig
}
...
export interface IndicatorConfig {
  ...
  // ========== EVAOS 数据源统一配置 ==========
  // Unified EVAOS / EVA API Key - used for all EVAOS data sources
  evaos_api_key?: string
  /** @deprecated use evaos_api_key — kept for strategy editor UI */
  eva_api_key?: string
