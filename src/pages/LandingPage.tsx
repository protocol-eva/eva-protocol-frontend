...
const COMMANDS = [
  ...
  },
  {
    ...
    hint: '/trend',
    prompt: 'What are the top trending coins today? Search for live data.',
  },
]
...
export function LandingPage() {
  ...
  // cursor-glow follows the mouse via a ref + rAF — no per-move re-render
  useEffect(() => {
    let raf = 0
    let lx = 0
    let ly = 0
    const onMove = (e: MouseEvent) => {
      ...
      raf = requestAnimationFrame(() => {
        ...
        if (el) {
          el.style.left = `${lx - 220}px`
          el.style.top = `${ly - 220}px`
        }
      })
    }
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              height: 440,
              background:
                'radial-gradient(circle, rgba(180,200,255,0.10) 0%, rgba(255,255,255,0.04) 45%, transparent 70%)',
              filter: 'blur(55px)',
                ...
                <div ref={chatBoxRef} className="flex items-stretch gap-2">
                  <div className="relative flex-1">
                    ...
                    <button
                      ...
                      aria-label={input.trim() ? 'Send' : 'Commands'}
                    >
                      {input.trim() ? (
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      ...
                      style={{ color: 'var(--accent-primary)' }}
                      aria-label={language === 'zh' ? '刷新' : 'Refresh'}
                    >
                  ...
                  <div className="overflow-y-auto flex-1">
                    {balancesLoading ? (
                      ...
                      <div
                        ...
                        style={{ color: 'var(--text-secondary)' }}
                      >
                        {language === 'zh' ? '未找到代币' : 'No tokens found'}
                      </div>
                    ) : (
