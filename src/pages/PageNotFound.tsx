    ...
    <DeepVoidBackground className="flex items-center justify-center text-center p-4">
      <div className="bg-nofx-bg border border-nofx-gold/20 p-8 rounded-lg max-w-md w-full relative overflow-hidden group">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6">
          ...
          <a
            href="/"
            className="flex items-center gap-2 px-6 py-3 bg-nofx-gold text-black font-bold text-sm uppercase tracking-widest rounded hover:bg-accent-hover transition-all shadow-neon hover:shadow-[0_0_20px_var(--accent-primary-glow)] group mt-4"
          >
            <Home size={16} />
