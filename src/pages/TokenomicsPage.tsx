...
import { EVA_SOLANA_MINT } from '../lib/upgradeConfig'
...
const ALLOCATIONS = [
  {
    ...
    pct: 55,
    color: '#3d6bff',
    desc: 'Solana launch — fair and transparent distribution',
  },
  {
    label: 'Treasury',
    pct: 20,
...
export function TokenomicsPage() {
  ...
  const handleCopy = () => {
    if (EVA_SOLANA_MINT === 'TBA') return
    navigator.clipboard.writeText(EVA_SOLANA_MINT)
    setCopied(true)
      ...
      <main className="pt-16 relative z-10">
        ...
        <section className="relative overflow-hidden px-4 py-20 sm:py-28 flex flex-col items-center text-center">
          ...
          >
            ...
            >
              The native utility and governance token powering the EVA protocol.
              Trade smarter, govern together.
            </p>
            ...
            >
              ...
              <span style={{ color: 'var(--text-primary)' }}>
                {EVA_SOLANA_MINT === 'TBA'
                  ? 'TBA'
                  : `${EVA_SOLANA_MINT.slice(0, 10)}…${EVA_SOLANA_MINT.slice(-8)}`}
              </span>
              <span
              ...
              >
                {EVA_SOLANA_MINT === 'TBA' ? 'TBA' : 'Live'}
              </span>
              <button
                onClick={handleCopy}
                className="ml-1 transition-opacity hover:opacity-70"
                disabled={EVA_SOLANA_MINT === 'TBA'}
              >
                {copied ? (
          ...
          >
            <div>
              <h2
                ...
                style={{ color: 'var(--text-primary)' }}
              >
                Be early to <span className="eva-shimmer">EVA</span>
              </h2>
              <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
                Follow our announcements for launch details, whitelist
                opportunities, and airdrop campaigns.
              </p>
            </div>
