...
export function DataPage() {
  ...
  const fetchGlobal = useCallback(async () => {
    try {
      // NOTE: no trailing slash before the query — Vercel's :path* rewrite does
                  ...
                  >
                    ...
                    {global && (
                      ...
                      >
                        ...
                        {global.marketCapChange.toFixed(1)}%
                      </span>
                    )}
                  </div>
                </div>
                  ...
                  const rows = [
                    {
                      ...
                      sub: `${btc.change24h >= 0 ? '+' : ''}${btc.change24h.toFixed(2)}%`,
                      ...
                      {coins.map((coin, idx) => (
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {coin.marketCap > 0
                                ? `${((coin.volume / coin.marketCap) * 100).toFixed(1)}% mcap`
                                : ''}
                            </div>
                          </td>
                          {/* 7d sparkline bar */}
