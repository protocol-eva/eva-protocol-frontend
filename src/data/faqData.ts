 ...
 * Comprehensive FAQ covering all aspects of EVA
 *
 * Categories:
...
export const faqCategories: FAQCategory[] = [
  // ===== 1. GETTING STARTED =====
  {
    ...
    items: [
      {
        id: 'what-is-eva',
        questionKey: 'faqWhatIsEVA',
        answerKey: 'faqWhatIsEVAAnswer',
      },
      {
        id: 'how-does-it-work',
  ...
  // ===== 6. SECURITY =====
  {
    ...
    items: [
      ...
      {
        id: 'can-eva-steal-funds',
        questionKey: 'faqCanEVAStealFunds',
        answerKey: 'faqCanEVAStealFundsAnswer',
      },
    ],
  },
